...
async def programming_theory_handler(callback: types.CallbackQuery):
    ...
    await callback.message.edit_text(
        text= (
        "<b>Theory!</b>\n\n"
        "In the following section, you are invited to choose one of three distinguished Soviet programming languages to study. Each language offers a fascinating glimpse into the past, allowing us to appreciate the ingenuity and innovation of our predecessors. So, which language will you embark on this journey with?"),
